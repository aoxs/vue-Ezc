...
// const Address = require('http://120.86.117.97:8579/api/WYDApi/UploadPhoto');//图片上传地址
export default {
  name: "TakePhotos",
  data() {
    return {
      abc1: [
        { name: 'abc', age: 88, sex: 1, },
        { name: 'abc', age: 88, sex: 1 },
        { name: 'abc', age: 88, sex: 1 },
        { name: 'abc', age: 88, sex: 1 },
        { name: 'abc', age: 88, sex: 1 },
      ...
      abc:[
        {
          test:[123,234,999,555]
        }
      ],

      columns: [
        { id: 1, name: "姓名",prop:'test[0]' }, 
        { id: 2, name: '年龄',prop:'test[1]' }, 
        { id: 3, name: '性别',prop:'test[2]'},
        { id: 3, name: '性别',prop:'test[3]'},
  ...
  methods: {
    ...
    onUpload() {
      if (this.imgSrc) {
        ...
        this.loading = true;
        fetch('http://120.86.117.97:8579/api/WYDApi/UploadPhoto', options)
          .then((response) => {
